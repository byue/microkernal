...
void localitytest(void) {
  ...
  // If LRU is implemented, the first ~4000 pages should not incur disk
  // operations Number of disk operations is around (2000 + 5000 + 4000) * 8 * 2
  // = 176000

  // we set threshold to be 230000 so any LRU-like implementation can pass our
  // test
